...
const { Student, student_body_validator, student_body_validator_update , id_validator } = require('../models/student')
//get All students
...
router.put('/id/:id',async (req,res)=>{
    ...
    var old_student = await Student.findByIdAndUpdate(req.params.id,student); // select * from Student
    if(!old_student) 
        return res.status(404).send('Student with this Id is missing');
